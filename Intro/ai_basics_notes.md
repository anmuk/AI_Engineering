Code editor - General purpose editor with feature to edit and run Code, e.g. VS code
IDE - All features of code editor + more features, e.g. Intellij for Java or Pycharm for python
...
ML - systems that learn patterns from data without being explicitly programmed with rigid rules
NN/DL - Advanced ML utilizing multi-layered neural networks to find complex patterns in massive datasets
...
Traditional ML -> classification, prediction, decision making
GenAI -> synthesise or generate image or text or code
GenAI has understanding and can do decision making based on what is best

Agntic AI -> systems that can understand + can also perform action
...
2017 - Transformers - ALgorithms that can understand data from the context -> optimized for compuation

speech to text - due to Transformers
GPT - also a result of transformers